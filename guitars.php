...
<div id="wrap">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span12">
                <ul class="thumbnails">
                    <li class="span4">
                        <div class="thumbnail">
                            <p class="text-center"><a href="#GuitarDetailsModal" data-toggle="modal">
                            ...
                            <p class="text-center">
                                <a href="#GuitarDetailsModal" role="button" class="btn btn-primary" data-toggle="modal">View details &raquo;</a>
                            </p>
                        </div>
                    </li>
        ...
        <!-- Guitar Modal -->
        <div id="GuitarDetailsModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="GuitarDetailsModalLabel" aria-hidden="true">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 id="GuitarDetailsModalLabel" class="text-center">Awesome Guitar</h3>
            </div>

            <div class="modal-body">
                <p class="text-center"><img src="img/GuitarBig.jpg"></p>
